...
public class ProductTypeLoader implements TypeLoader {
	...
	public Map<String, Class<? extends ManagedObjectImpl>> loadImplementationClasses() {
		...
		map.put("process.Performer", cn.edu.buaa.sei.process.PerformerImpl.class);
		map.put("process.ProcessParameter", cn.edu.buaa.sei.process.ProcessParameterImpl.class);
		map.put("process.ResponsibleAssign", cn.edu.buaa.sei.process.ResponsibleAssignImpl.class);
