...
public interface ExistentialQuantification extends AtLeastQuantification {
	
	public static final String TYPE_NAME = "logicformulation.ExistentialQuantification";
