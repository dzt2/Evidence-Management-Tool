...
public class ContextImpl extends ManagedObjectImpl implements Context, SUtilityNode, SInformationElement {
	...
	public List<Assertion> getAssertions() {
		return get(Context.KEY_ASSERTIONS).listContent().toGenericList(Assertion.class);
	}
